...
|------------------------------------------------------------------------------------|------------------------------------------------------------------------------|--------------------------------------------------------------|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------|
| [All-in-One (Recommended)](https://noctvm.io/dl/playfield/playfield-all-0.8.6.zip) | [Windows 32-bit](https://noctvm.io/dl/playfield/playfield-win32-0.8.6.zip)   | [macOS](https://noctvm.io/dl/playfield/Playfield-0.8.6.dmg)  | [AppImage x86_64](https://noctvm.io/dl/playfield/Playfield-0.8.6-x86_64.AppImage)    | [iOS](https://noctvm.io/dl/playfield/playfield-ios-0.8.6.zip)            |
| [Source Code](Https://noctvm.io/dl/playfield/playfield-src-0.8.6.zip)              | [Windows 64-bit](https://noctvm.io/dl/playfield/playfield-win64-0.8.6.zip)   |                                                              |                                                                                      | [Android](https://noctvm.io/dl/playfield/playfield-android-0.8.6.zip)    |
| [Samples](https://noctvm.io/dl/playfield/playfield-samples-0.8.6.zip)              | [Windows Arm64](https://noctvm.io/dl/playfield/playfield-winarm64-0.8.6.zip) |                                                              |                                                                                      | [WebAssembly](https://noctvm.io/dl/playfield/playfield-wasm-0.8.6.zip)   |
|                                                                                    |                                                                              |                                                              |                                                                                      | [Unity Plugin](https://noctvm.io/dl/playfield/playfield-unity-0.8.6.zip) |
