...
/*
 * Playfield Engine
 * SSE2 version of the image processing functions.
 */
...
#define DRAW_IMAGE_COPY		draw_image_copy_sse2
#define DRAW_IMAGE_ALPHA	draw_image_alpha_sse2
#define DRAW_IMAGE_GLYPH	draw_image_glyph_sse2
