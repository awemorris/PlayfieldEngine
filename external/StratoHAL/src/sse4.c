...
/*
 * Playfield Engine
 * SSE4.1 version of the image processing functions.
 */
...
#define DRAW_IMAGE_COPY		draw_image_copy_sse4
#define DRAW_IMAGE_ALPHA	draw_image_alpha_sse4
#define DRAW_IMAGE_glyph	draw_image_glyph_sse4
