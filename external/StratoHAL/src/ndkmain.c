...
/*
 * com.noctvm.engineandroid.MainActivity.nativeInitGame()
 */
JNIEXPORT void JNICALL
Java_com_noctvm_engineandroid_MainActivity_nativeInitGame(
	JNIEnv *env,
	jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_com_noctvm_engineandroid_MainActivity_nativeReinitOpenGL(
        JNIEnv *env,
        jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_com_noctvm_engineandroid_MainActivity_nativeCleanup(
	JNIEnv *env,
	jobject instance)
{
	jni_env = env;
...
Java_com_noctvm_engineandroid_MainActivity_nativeRunFrame(
	JNIEnv *env,
	jobject instance)
{
	jni_env = env;
	...
	bool do_render = true;
	if (state_video) {
		jclass cls = (*jni_env)->FindClass(jni_env, "com/noctvm/engineandroid/MainActivity");
...
JNIEXPORT void JNICALL
Java_com_noctvm_engineandroid_MainActivity_nativeOnPause(
        JNIEnv *env,
        jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_com_noctvm_engineandroid_MainActivity_nativeOnResume(
        JNIEnv *env,
        jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_com_noctvm_engineandroid_MainActivity_nativeOnTouchStart(
        JNIEnv *env,
        jobject instance,
        jint x,
        jint y,
...
JNIEXPORT void JNICALL
Java_com_noctvm_engineandroid_MainActivity_nativeOnTouchMove(
	JNIEnv *env,
	jobject instance,
	jint x,
	jint y)
...
JNIEXPORT void JNICALL
Java_com_noctvm_engineandroid_MainActivity_nativeOnTouchEnd(
	JNIEnv *env,
	jobject instance,
	jint x,
	jint y,
