...
WSL2 のターミナルを起動し、`PicoPicoScript` ディレクトリに入り、次のコマンドをタイプする。
...
MSYS2 のターミナルを起動し、`PicoPicoScript` ディレクトリに入り、次のコマンドをタイプする。
...
* `PicoPicoScript` ソースツリーが展開されていること
...
ターミナルを開き、`PicoPicoScript` ディレクトリに入り、次のコマンドをタイプする。
...
ターミナルで `PicoPicoScript` ディレクトリに入り、次のコマンドをタイプする。
